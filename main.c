...
int main()
{
    //N: the number that the user enters
    //tetr: the square of the number N
    //A,B: the two parts that we divide the number 
    //done: flag to indicte if we found a Kaprekar match
    //i: divider used to split the square into two parts
